$(function () {
    ...
    $.ajax({
        type: 'GET',
        url: 'js/usmap/xml/usaMapSettings.xml',
    ...
    function createMap() {
        ...
        for (var state in usamappaths) {
            ...
            hitArea.click(function(){
                var id = $(this.node).attr('id');
                window.location.href = "#page_state?state="+stateNames[id];
            });
        }
	...
	function responsiveResize(){
			...
			if (winWidth >= 960) {
				...
				mapWidth = useTextAtBottom ? 900 : 900  - (parseFloat(textAreaWidth) - parseFloat(textAreaPadding * 2));
				mapHeight = mapWidth/ratio;
				resizeMap();
			}
